...
:::{layout-ncol=3}
![](data-raw/grid/polygon.png)

![](data-raw/grid/grid-cells.png)

![](data-raw/grid/image.png)
:::
...
## Spatial Sampling {.smaller}

<br>

::: {.columns layout-ncol=3 style="text-align: center;"}

![Find a map](data-raw/grid/s3msampling.png)

![Make even spread sampling points](data-raw/grid/even-spread-spoints.png)

![Select communities to survey](data-raw/grid/select-communities.png)
